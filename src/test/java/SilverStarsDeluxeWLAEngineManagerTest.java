...
public class SilverStarsDeluxeWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(SilverStarsDeluxeWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/SilverStarsSupremeWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/SilverStarsSupremeWLAIW/InitOutcome.xml").getDocumentElement();
